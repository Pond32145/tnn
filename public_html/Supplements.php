...
<?php 
    $name_product = $product_supplements['name_product'];
    $part_product_items = $product_supplements['part_file'];
    $product_items = $product_supplements['product_item'];
    $image_product = $product_supplements['image_product'];
    $count = $product_supplements['count_item'];
?>
        ...
        <div class="container container_show_product">
            <div class="box_grid_product">
               <?php for ($y=1;$y <= $count;$y++) { ?>
                <a href="./productDetail.php?item=<?php echo $product_items . $y ?>&category=supplements" id="w-node-fa7b6bf6-1bff-0acd-a31e-5e455d4fb77d-79303951" class="grid_item_product">
