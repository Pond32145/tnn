...
<head>
    ...
    <style>
        .body {
            ...
            /* ให้รูปภาพครอบคลุมพื้นที่ทั้งหมดของหน้าจอ */
        ...
        .form_main {
            ...
            /* ใช้สีพื้นหลังในรูปแบบ rgba เพื่อให้เป็นสีขาวทึบที่มีความโปร่งใส */
            padding: 30px;
...
<body>
    <div class="body">
        ...
        <form action="login_process.php" method="post" class="form_main">
            ...
            <p class="heading">T&N Chemical</p>
            ...
            <?php if ($alert): ?>
                <div style="color: red;"><?php echo htmlspecialchars($alert); ?></div>
            <?php endif; ?>
